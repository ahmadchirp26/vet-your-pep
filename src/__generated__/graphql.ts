...
export type GetMyChannelsQuery = { __typename?: 'Query', getMyChannels: { __typename?: 'ListChannelsResponse', limit: number, offset?: number | null, totalRows?: number | null, results: Array<{ __typename?: 'Channel', about?: string | null, backgroundImage?: string | null, id: string, image?: string | null, isPaid: boolean, moderatorId: string, price?: number | null, rules?: string | null, status: ChannelStatus, title: string, totalMembers?: number | null, members?: Array<{ __typename?: 'ChannelMember', id: string, paidStatus: boolean, roleChannel: ChannelUserRole, customer: { __typename?: 'Customer', cellPhone?: string | null, email: string, firstName: string, id: string, isActive?: boolean | null, lastName: string, password: string, profileImage?: string | null, role: UserRole, stripeCustomerId?: string | null, totalFollowers?: number | null, totalFollowings?: number | null } }> | null }> } };
