            ...
            <div className=" bg-black rounded-lg w-1/2 p-4 mt-10 bg-opacity-85 max-xl:w-3/4">
              <div className="flex flex-col items-center gap-4 ">
                ...
                <span className="text-graylight text-center">
                  ...
                  volutpat a. Quisque suscipit magna ac vestibulum auctor. Cras
                  luctus justo quis tellus tincidunt lacinia. Sed tristique
                  tortor nibh, vel viverra orci fermentum sed. Nulla massa leo,
                  efficitur sit amet urna hendrerit, auctor viverra erat. Ut in
                  arcu risus.
                </span>
              </div>
            </div>
